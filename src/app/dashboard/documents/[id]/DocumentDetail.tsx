    ...
    <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-xl border border-[#E5E5E5] p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
              ...
              disabled={generating !== null}
              className="group flex flex-col items-center p-6 border border-[#E5E5E5] rounded-xl hover:border-[#0A0A0A] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <div className="w-12 h-12 border border-[#E5E5E5] rounded-lg flex items-center justify-center mb-3">
      ...
      {quizzes.length > 0 && (
        <div className="bg-white rounded-xl border border-[#E5E5E5] p-6">
          <h2 className="text-lg font-semibold text-[#0A0A0A] mb-4">Generated Materials</h2>
          <div className="divide-y divide-[#F5F5F5]">
            {quizzes.map((quiz) => (
              <Link
                key={quiz.id}
                href={`/dashboard/quizzes/${quiz.id}`}
                className="block py-3 px-4 hover:bg-[#F5F5F5] rounded-lg transition-colors"
              >
