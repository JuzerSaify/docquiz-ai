  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-semibold text-[#0A0A0A] tracking-tight">Welcome back, {firstName}</h1>
          <p className="text-sm text-[#737373] mt-1">Here&apos;s an overview of your study progress</p>
        </div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-base font-semibold text-[#0A0A0A]">Upload Document</h2>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div>
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-base font-semibold text-[#0A0A0A]">Recent Documents</h2>
            <Link href="/dashboard/documents" className="text-xs text-[#737373] hover:text-[#0A0A0A] transition-colors">
              View all &rarr;
            </Link>
          </div>
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-base font-semibold text-[#0A0A0A]">Recent Quizzes</h2>
            <Link href="/dashboard/quizzes" className="text-xs text-[#737373] hover:text-[#0A0A0A] transition-colors">
              View all &rarr;
            </Link>
          </div>
          <div className="border border-[#E5E5E5] rounded-xl overflow-hidden">
