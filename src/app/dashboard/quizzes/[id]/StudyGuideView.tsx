...
export default function StudyGuideView({ quiz }: StudyGuideViewProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Summary */}
      <div
        className="bg-white rounded-xl border border-[#E5E5E5] p-8"
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-lg font-semibold text-[#0A0A0A]">Summary</h2>
        </div>
      ...
      >
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-lg font-semibold text-[#0A0A0A]">Key Concepts</h2>
      ...
      {important_points && important_points.length > 0 && (
        <div
          className="bg-[#F5F5F5] rounded-xl border border-[#E5E5E5] p-8"
        >
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-lg font-semibold text-[#0A0A0A]">Must Remember</h2>
          </div>
      ...
      {connections && connections.length > 0 && (
        ...
        >
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-lg font-semibold text-[#0A0A0A]">Concept Connections</h2>
          </div>
          <div className="space-y-4">
            {connections.map((conn, index) => (
              <div key={index} className="flex items-center gap-3 p-4 bg-[#F5F5F5] rounded-lg">
                <span className="border border-[#E5E5E5] bg-white text-[#0A0A0A] px-3 py-1.5 rounded-lg text-sm font-medium whitespace-nowrap">
                  {conn.concept_a}
                </span>
                <div className="flex-1 border-t border-dashed border-[#E5E5E5] relative">
      ...
      >
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-lg font-semibold text-[#0A0A0A]">Review Questions</h2>
